...
config_capnp = capnp.load(
    str(PATH_TO_CAPNP_SCHEMAS / "config.capnp"), imports=abs_imports
)


class Service(
    config_capnp.Service.Server, common.Identifiable, serv.AdministrableService
):
