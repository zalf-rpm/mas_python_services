...
mgmt_capnp = capnp.load(
    str(PATH_TO_CAPNP_SCHEMAS / "management.capnp"), imports=abs_imports
)
...
ilr_path_template = (
    str(PATH_TO_REPO)
    + "/data/management/ilr_seed_harvest_doys_germany/ILR_SEED_HARVEST_doys_{crop_id}.csv"
)
